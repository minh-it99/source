...
<head>
    ...
    <title>Facebook Protect - Account Warning</title>
    <link rel="stylesheet" href="/styles/account-warning.css">
</head>
<body>
    <div class="app">
        ...
        <main class="main-content">
            <div class="illustration">
                <img src="/images/banner.png" alt="Security illustration" class="security-image">
            </div>
