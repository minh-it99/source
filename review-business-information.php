...
<head>
    ...
    <title>Review Business Information - Meta Business</title>
...
<body>
    <nav class="meta-nav">
        ...
        <svg aria-label="" class="meta-small"  role="img" viewBox="0 0 500 100">
                <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" x1="124.38" x2="160.839" y1="99" y2="59.326">
                        <stop offset=".427" stop-color="#0278F1"></stop>
                        <stop offset=".917" stop-color="#0180FA"></stop>
                    </linearGradient>
                    <linearGradient gradientUnits="userSpaceOnUse" x1="42" x2="-1.666" y1="4.936"
                        y2="61.707">
                        <stop offset=".427" stop-color="#0165E0"></stop>
                        <stop offset=".917" stop-color="#0180FA"></stop>
                    </linearGradient>
                    <linearGradient gradientUnits="userSpaceOnUse" x1="27.677" x2="132.943" y1="28.71"
                        y2="71.118">
    ...
    <main class="main-container">
        <div class="review-card">
            ...
            <div class="business-info">
                ...
                <div class="business-details">
                    ...
                    <div class="verification-status">
                        ...
                        <span class="info-icon" data-tooltip="This business hasn't been verified by Meta yet">ⓘ</span>
                    </div>
                </div>
            </div>
            ...
            <div class="caution-section">
                <p>
                    Use caution accepting requests from a business portfolio you don't know. If you don't know this business, you can 
                    <a href="#" class="decline-link">decline the invitation</a>.
                </p>
            </div>
            ...
            <div class="navigation-footer">
                ...
                <span class="page-indicator">2 of 3</span>
    ...
    <footer class="meta-footer">
        ...
        <div class="footer-info">
            ...
            <span class="copyright">Meta © 2025</span>
        </div>
    </footer>
